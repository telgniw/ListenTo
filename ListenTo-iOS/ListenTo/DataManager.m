...
-(void)createCustomWallData
{
    yValuesArray=[[NSArray alloc]initWithObjects:@"45%",@"60%",@"78%",@"67%",@"90%",@"94%",@"99%",nil];
    xTitlesArray=[[NSArray alloc]initWithObjects:@"星期一",@"星期二",@"星期三",@"星期四",@"星期五",@"星期六",@"星期日", nil];
    xValuesArray=[[NSArray alloc]initWithObjects:@"星期一",@"星期二",@"星期三",@"星期四",@"星期五",@"星期六",@"星期日", nil];
}
